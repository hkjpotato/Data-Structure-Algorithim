...
public class Sorting {
    ...
    public static <T> void insertionsort(T[] arr, Comparator<T> comparator) {
        ...
        for (int i = 1; i < arr.length; i++) {
            ...
            while (position > 0
                    &&
                    comparator.compare(arr[position - 1], arr[position]) > 0) {
     ...
     * @param rand the Random object used to select pivots
     */
    private static <T> void myQuicksort(T[] arr, int low, int high,
...
//        }
    ...
    /**
     * Merge sort helper method to merge sort a certain part of the given array
     *
     * @param <T> data type to sort
     * @param arr the given array
     * @param tempArr the temporary array used to help store the data
     * @param beg the start index of the part to be merge sorted
     * @param end the end index of the part to be merge sorted
     * @param comparator the Comparator used to compare the data in arr
     */
    private static <T> void myMergesort(T[] arr, T[] tempArr, int beg, int end,
     ...
     * @param comparator the Comparator used to compare the data in arr
     */
    private static <T> void combine(T[] arr, T[] tempArr,
